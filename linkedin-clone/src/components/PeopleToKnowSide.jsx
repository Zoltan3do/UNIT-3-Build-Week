...
const PeopleToKnowSide = () => {
  ...
  const [connected, setConnected] = useState({}); // Stato per tracciare quali utenti sono collegati
      ...
      {profiles.slice(0, 5).map((profile) => (
        <Card key={profile._id} className="mb-1 p-1">
          <Card.Body className="d-flex align-items-center">
            ...
            />
            <div>
              <Card.Title style={{ fontSize: '1rem' }}>{profile.name} {profile.surname}</Card.Title>
